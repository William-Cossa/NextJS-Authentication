...
async function ListUsers() {
  ...
  return (
    ...
    <div className="flex justify-between items-center mb-4">
        <h3 className="text-lg font-bold leading-none text-gray-900 dark:text-white">Usuários recentes</h3>
        <Link href="" className="text-xs font-medium text-blue-600 hover:underline dark:text-blue-500">
           Ver todos
        </Link>
   </div>
